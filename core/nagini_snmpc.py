...
# ----------------------------------------------------------------------------
# Import modules
from functions import nagini_snmp
from functions import nagini_csv
from functions import nagini_log
from functions import nagini_dir
from functions import nagini_global
from pysnmp import hlapi
import configparser

def prn_snmp_chk(prn_file, config_file, snmp_file):
    """
    ...
    config.read(config_file)  # Read the config_file contents.
    ...
    serial_oid = config.get('HP', 'serial_oid')  # Define Serialnumber oid.
...
def env_chk(prn_file, snmp_file):
    """
    Function to check SNMP directories and files exist.
    """
