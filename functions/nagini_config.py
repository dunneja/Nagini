...
class config_file():
    ...
    def check_conf(self):
        ...
        # If the config_file does not exist then create a template.
            ...
            config.set('main', 'default_vendor', 'HP')
            # Create Xerox config layout.
            config.add_section('Xerox')
            # Hostname.
            config.set('Xerox', 'snmp_hostname_oid', '1.3.6.1.2.1.1.5.0')
            # Sysloc.
            config.set('Xerox', 'sys_location_oid', '1.3.6.1.2.1.1.6.0')
            # Mac Address.
            config.set('Xerox', 'mac_addr_oid', '1.3.6.1.2.1.2.2.1.6.1')
            # Mono.
            config.set('Xerox', 'mono_oid',
                       '1.3.6.1.4.1.253.8.53.13.2.1.6.1.20.34')
            # Color.
            config.set('Xerox', 'color_oid',
                       '1.3.6.1.4.1.253.8.53.13.2.1.6.1.20.33')
            # Total counts.
            config.set('Xerox', 'total_oid',
                       '1.3.6.1.4.1.253.8.53.13.2.1.6.1.20.1')
            # Device desc oid.
            config.set('Xerox', 'hr_Device_Descr_oid',
                       '1.3.6.1.2.1.25.3.2.1.3.1')
            # Sys firmware oid.
            config.set('Xerox', 'sys_Descr_oid', '1.3.6.1.2.1.1.1.0')
            # Serialnumber oid.
            config.set('Xerox', 'serial_oid', '1.3.6.1.2.1.43.5.1.1.17.1')
            # Create HP config layout.
            config.add_section('HP')
            # Hostname.
            config.set('HP', 'snmp_hostname_oid',
                       '1.3.6.1.4.1.11.2.3.9.4.2.1.1.3.10.0')
            # Sysloc.
            config.set('HP', 'sys_location_oid', '1.3.6.1.2.1.1.6.0')
            # Mac Address.
            config.set('HP', 'mac_addr_oid', '1.3.6.1.2.1.2.2.1.6.1')
            # Mono.
            config.set('HP', 'mono_oid',
                       '1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.2.6.0')
            # Color.
            config.set('HP', 'color_oid',
                       '1.3.6.1.4.1.11.2.3.9.4.2.1.4.1.2.7.0')
            # Total counts.
            config.set('HP', 'total_oid', '1.3.6.1.2.1.43.10.2.1.4.1.1')
            # Device desc oid.
            config.set('HP', 'hr_Device_Descr_oid', '1.3.6.1.2.1.25.3.2.1.3.1')
            # Sys firmware oid.
            config.set('HP', 'sys_Descr_oid', '1.3.6.1.2.1.1.1.0')
            # Serialnumber oid.
            config.set('HP', 'serial_oid', '1.3.6.1.2.1.43.5.1.1.17.1')
