...
from icons.nagini_icons import warning, printer
...
def csv_viewer():
    ...
    filename = sg.popup_get_file('filename to open', no_window=True,
                                 icon=warning_base64, file_types=(("CSV Files", "*.csv"),))
    ...
    button = sg.popup_yes_no(
        'Does this file have column names already?', icon=warning_base64)
    ...
    window = sg.Window('CSV Viewer', layout, grab_anywhere=False,
                       keep_on_top='True', icon=printer_base64, relative_location=(0, 0))
